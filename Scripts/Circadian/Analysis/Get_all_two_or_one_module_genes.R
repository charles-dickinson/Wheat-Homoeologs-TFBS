...
only_triads <- function(full_dataset){
  ...
  fwrite(triad_genes[,.(gene,triad)], 'data/circadian/produced/triad_mapping.csv')
  triad_genes
}
...
generate_two_module_data <- function(triad_data){
  ...
  fwrite(only_true_triads, 'data/circadian/produced/two_one_module_genes/two_one_modules_phase_per_gene.csv')
  only_true_triads
}
...
module_gene_list <- fread('data/circadian/produced/all_module_genes/all_module_genes_list.csv')
...
fwrite(phase_categs, 'data/circadian/produced/two_one_module_genes/two_one_modules_phase_categories.csv')